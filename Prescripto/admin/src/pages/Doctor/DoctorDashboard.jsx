  ...
  return dashData && (
    <div className='w-full max-w-6xl m-5'>
      ...
      <div className='bg-white'>
        <div className='flex items-center gap-2.5 px-4 py-4 mt-10 rounded-t broder'>
          <img src={assets.list_icon} alt="" />
          <p className='font-semibold'>Lasest Booking</p>
        </div>

        <div className='pt-4 border border-t-0'>
          {
            dashData.lastestAppoinments.map((item, index) => (
