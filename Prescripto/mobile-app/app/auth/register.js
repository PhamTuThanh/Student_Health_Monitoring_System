...
<head>
  ...
  <style>
    ...
    input[type='email'], input[type="text"], input[type="number"], input[type="url"], input[type="search"], input[type="password"] {
      ...
      background-color: #f3fafd; border: solid 2px #217093; border-radius: 4px; -webkit-appearance: none;
    ...
    button {
      ...
      background-color: #4eb8dd; border: none; border-radius: 4px;
    ...
    #showPasswordToggle .indicator {
      ...
      background-color: #f3fafd; border: solid 2px #217093; border-radius: 3px;
    }
    #showPasswordToggle .indicator:after {
      content: "";
      position: absolute; left: .25em; top: .025em;
      width: .2em; height: .5em;
      border: solid #217093; border-width: 0 3px 3px 0;
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/1.20.3/plugins/MorphSVGPlugin.min.js"></script>
</head>
<body>
  <form>
